...
img = ImageTk.PhotoImage(Image.open('nature.png'))
...
lable_unit.place(x=22,y=280)

lable_unit = Label(root,text="----By Sahil Janbandhu",width = 35,bg='white',font=("bold",10),fg='brown')
lable_unit.place(x=22,y=300)
